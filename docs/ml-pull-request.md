...
Opening a pull request will trigger a[workflow](../.github/workflows/my-mlops-project-stijn-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-my-mlops-project-stijn-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-my-mlops-project-stijn-model)
