...
```
my-mlops-project-stijn         <- Root directory. Both monorepo and polyrepo are supported.
│
├── my_mlops_project_stijn       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
