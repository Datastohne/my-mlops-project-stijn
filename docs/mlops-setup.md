...
[ML Config](../my_mlops_project_stijn/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore my_mlops_project_stijn/databricks-resources/README.md
...
Follow the instructions in [my-mlops-project-stijn/databricks-resources/README.md](../my_mlops_project_stijn/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../my_mlops_project_stijn/databricks-resources/README.md)  to propose, test, and deploy
