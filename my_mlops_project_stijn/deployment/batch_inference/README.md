# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [my_mlops_project_stijn/databricks-resources/README.md](../../databricks-resources/README.md)
