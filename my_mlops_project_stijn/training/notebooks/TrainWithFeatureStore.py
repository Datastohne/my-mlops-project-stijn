...
# ``my_mlops_project_stijn/databricks-resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-my-mlops-project-stijn-experiment",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev-my-mlops-project-stijn-model", label="Model Name"
)
