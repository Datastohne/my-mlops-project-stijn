...
and [ML resource config guide](my_mlops_project_stijn/databricks-resources/README.md) to propose, test, and deploy changes to production ML code (e.g. update model parameters)
...
| Data Scientist                | Modify production model ML resources, e.g. model training or inference jobs  | [ML resource config guide](my_mlops_project_stijn/databricks-resources/README.md)                                                     |
